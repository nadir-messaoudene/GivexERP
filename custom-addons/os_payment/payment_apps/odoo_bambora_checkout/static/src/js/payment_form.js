odoo.define('odoo_bambora_checkout.payment_form', function(require) {
    ...
    const bamborachkMixin = {
        ...
        _getInlineFormBamboraInputs: function(acquirerId) {
            debugger
            return {
        ...
        _getPaymentDetails: function(acquirerId) {
            const inputs = this._getInlineFormBamboraInputs(acquirerId);
            try {
         ...
         * @private
         * @param {string} code - The acquirer of the selected payment option's acquirer
        ...
        _prepareInlineForm: function(provider, paymentOptionId, flow) {
            ...
            let self = this;
            return this._rpc({
                    route: "/payment/bamborachk/get_acquirer_info",
                    params: {
         ...
         * @override method from payment.payment_form_mixin
         * @private
         * @param {string} acquirer - The acquirer of the payment option's acquirer
         * @param {number} paymentOptionId - The id of the payment option handling the transaction
         * @param {string} flow - The online payment flow of the transaction
         * @return {Promise}
         */
        _processPayment: function(acquirer, paymentOptionId, flow) {
            console.log("--------------------------------------");
            ...
            if (acquirer !== "bamborachk" || flow === "token") {
         ...
         * @return {Promise}
         */
        _processDirectPayment: function(acquirer, acquirerId, processingValues) {
            console.log("acquirer ===>>>", acquirer);
            console.log("acquirerId ===>>>", acquirerId);
            console.log("processingValues ===>>>", processingValues);

            if (acquirer !== "bamborachk") {
                return this._super(...arguments);
            }
         ...
         */
        _validateBamboraFormInputs: function(acquirerId) {
            debugger
            console.log("_validateBamboraFormInputs ===>>>");
            const inputs = Object.values(this._getInlineFormBamboraInputs(acquirerId));
        ...
        processTokenSuccess(result) {
            ...
            var $checkedRadio = $('input[name="o_payment_radio"]:checked');
            var PaymentOptionId = _getPaymentOptionIdFromRadio($checkedRadio);
            var acquirerForm = $('#o_payment_add_token_acq_' + PaymentOptionId);
            var inputsForm = $('input', acquirerForm);
