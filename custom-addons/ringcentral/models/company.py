...
class ResCompany(models.Model):
    ...
    ringcentral_server = fields.Char(
        'Ringcentral Server',
        help='Use ringcentral API server URL'
    )
    ...
    ringcentral_service_uri = fields.Char(
        'Ringcentral Service URI', help='Use ringcentral online portal')
    ringcentral_app_host = fields.Char(
        'Ringcentral Host',
        help='Use ringcentral API server URL with out using protocol.'
    )
    ringcentral_app_port = fields.Char(
        'Ringcentral Port', help='Use current odoo Port')
